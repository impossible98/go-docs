...
This package implements standard block cipher modes that can be wrapped around low-level block cipher implementations. See https://csrc.nist.gov/groups/ST/toolkit/BCM/current_modes.html and NIST Special Publication 800-38A.
...
- [cbc.go](/code/crypto/cipher/cbc)
- [cfb.go](/code/crypto/cipher/cfb)
- [cipher.go](/code/crypto/cipher/cipher)
- [ctr.go](/code/crypto/cipher/ctr)
- [gcm.go](/code/crypto/cipher/gcm)
- [io.go](/code/crypto/cipher/io)
- [ofb.go](/code/crypto/cipher/ofb)
- [xor_amd64.go](/code/crypto/cipher/xor_amd64)
